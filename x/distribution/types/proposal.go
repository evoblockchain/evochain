...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(CommunityPoolSpendProposal{}, "evoblockchain/distribution/CommunityPoolSpendProposal")
	govtypes.RegisterProposalTypeCodec(ChangeDistributionTypeProposal{}, "evoblockchain/distribution/ChangeDistributionTypeProposal")
	govtypes.RegisterProposalTypeCodec(WithdrawRewardEnabledProposal{}, "evoblockchain/distribution/WithdrawRewardEnabledProposal")
	govtypes.RegisterProposalTypeCodec(RewardTruncatePrecisionProposal{}, "evoblockchain/distribution/RewardTruncatePrecisionProposal")
}
