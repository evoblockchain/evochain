...
import (
	...
	authtxb "github.com/evoblockchain/evochain/libs/cosmos-sdk/x/auth/types"
...
func getCmdNewOrder(cdc *codec.Codec) *cobra.Command {
	...
	cmd.Flags().StringVarP(&product, "product", "", "", "Trading pair in full name of the tokens: ${baseAssetSymbol}_${quoteAssetSymbol}, for example \"mycoin_evo\".")
