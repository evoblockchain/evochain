...
import (
	...
	"github.com/evoblockchain/evochain/x/gov/client/utils"

	"github.com/evoblockchain/evochain/libs/cosmos-sdk/client/flags"
	"github.com/evoblockchain/evochain/x/gov/types"
)
...
Example:
$ %s query gov proposals --depositor evo1ss60jyagpw8v224006cqdkw22m32ytz54av3h3
$ %s query gov proposals --voter evo1ss60jyagpw8v224006cqdkw22m32ytz54av3h3
...
Example:
$ %s query gov vote 1 evo1ss60jyagpw8v224006cqdkw22m32ytz54av3h3
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query gov deposit 1 evo1ss60jyagpw8v224006cqdkw22m32ytz54av3h3
`,
				version.ClientName,
			),
		),
