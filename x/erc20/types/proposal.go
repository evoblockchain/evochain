...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(TokenMappingProposal{}, "evoblockchain/erc20/TokenMappingProposal")
	govtypes.RegisterProposalTypeCodec(ProxyContractRedirectProposal{}, "evoblockchain/erc20/ProxyContractRedirectProposal")
	govtypes.RegisterProposalTypeCodec(ContractTemplateProposal{}, "evoblockchain/erc20/ContractTemplateProposal")
}
