...
const (
	...
	ManageContractDeploymentWhitelistProposalName = "evoblockchain/evm/ManageContractDeploymentWhitelistProposal"
	ManageContractBlockedListProposalName         = "evoblockchain/evm/ManageContractBlockedListProposal"
)
...
func RegisterCodec(cdc *codec.Codec) {
	...
	cdc.RegisterConcrete(ManageContractMethodBlockedListProposal{}, "evoblockchain/evm/ManageContractMethodBlockedListProposal", nil)
	cdc.RegisterConcrete(ManageSysContractAddressProposal{}, "evoblockchain/evm/ManageSysContractAddressProposal", nil)
