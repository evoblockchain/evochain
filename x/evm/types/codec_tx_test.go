...
func (ee *exAminoEncoder) name() string { return "evochain-amino" }
...
func TestEncoder(t *testing.T) {
	...
	testEncoder(t, newTestEncoder(exAminoEnc))  // test evochain-amino
	testEncoder(t, newTestEncoder(jsonEnc))     // test evochain-json
}
