...
const (
 ...
 IsAdded:				true
 DistributorAddrs:
						evo1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqm2k6w2
						evo1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqpxuz0nc`
 ...
 IsAdded:				true
 ContractList:
						Address: evo1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqm2k6w2
Method List:
Sign: 0x11111111Extra: TEST1
Sign: 0x22222222Extra: TEST2
						Address: evo1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqpxuz0nc
Method List:
...
func (suite *ProposalTestSuite) TestProposal_ManageSysContractAddressProposal() {
 ...
 ContractAddr:          evo1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqm2k6w2
 IsAdded:				true`
