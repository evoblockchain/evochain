...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(ManageContractDeploymentWhitelistProposal{}, "evoblockchain/evm/ManageContractDeploymentWhitelistProposal")
	govtypes.RegisterProposalTypeCodec(ManageContractBlockedListProposal{}, "evoblockchain/evm/ManageContractBlockedListProposal")
	govtypes.RegisterProposalTypeCodec(ManageContractMethodBlockedListProposal{}, "evoblockchain/evm/ManageContractMethodBlockedListProposal")
	govtypes.RegisterProposalTypeCodec(ManageSysContractAddressProposal{}, "evoblockchain/evm/ManageSysContractAddressProposal")
}
...
// FixShortAddr is to fix the short address problem in the EVO test-net.
// The normal len(BlockedContract.Address) should be 20,
// but there are some BlockedContract.Address in EVO test-net that have a length of 4.
