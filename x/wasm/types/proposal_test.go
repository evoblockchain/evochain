...
`,
		...
		"update deployment whitelist": {
			src: &UpdateDeploymentWhitelistProposal{
				Title:            "Foo",
				Description:      "Bar",
				DistributorAddrs: []string{"evo1ss60jyagpw8v224006cqdkw22m32ytz54av3h3", "evo1ss60jyagpw8v224006cqdkw22m32ytz54av3h3"},
			},
			exp: `title:"Foo" description:"Bar" distributorAddrs:"evo1ss60jyagpw8v224006cqdkw22m32ytz54av3h3" distributorAddrs:"evo1ss60jyagpw8v224006cqdkw22m32ytz54av3h3" `,
		},
	}
	for msg, spec := range specs {
		t.Run(msg, func(t *testing.T) {
...
- evo1ss60jyagpw8v224006cqdkw22m32ytz54av3h3
- evo1ss60jyagpw8v224006cqdkw22m32ytz54av3h3
`,
		},
	}
			...
			src: `
{
	"title": "foo",
	"description": "bar",
	"distributorAddrs": ["evo1ss60jyagpw8v224006cqdkw22m32ytz54av3h3", "evo1ss60jyagpw8v224006cqdkw22m32ytz54av3h3"]
}`,
...
func TestProposalJsonSignBytes(t *testing.T) {
	...
	specs := map[string]struct {
		...
		"instantiate contract": {
			...
			exp: `
{
	"type":"evoblockchain/gov/MsgSubmitProposal",
			...
			exp: `
{
	...
	"value":{"content":{"type":"wasm/MigrateContractProposal","value":{"msg":{"foo":"bar"}}},"initial_deposit":[],"proposer":""}
		...
		"update wasm deployment whitelist": {
			src: &UpdateDeploymentWhitelistProposal{DistributorAddrs: []string{"evo1ss60jyagpw8v224006cqdkw22m32ytz54av3h3", "evo1ss60jyagpw8v224006cqdkw22m32ytz54av3h3"}},
			exp: `
{	
	"type":"evoblockchain/gov/MsgSubmitProposal",
	"value":{"content":{"type":"wasm/UpdateDeploymentWhitelistProposal","value":{"distributorAddrs":["evo1ss60jyagpw8v224006cqdkw22m32ytz54av3h3","evo1ss60jyagpw8v224006cqdkw22m32ytz54av3h3"]}},"initial_deposit":[],"proposer":""}
}`,
		},
	}
	for name, spec := range specs {
