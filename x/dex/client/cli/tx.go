...
import (
	...
	"github.com/evoblockchain/evochain/libs/cosmos-sdk/x/auth/client/utils"
	"github.com/evoblockchain/evochain/x/common"
	dexUtils "github.com/evoblockchain/evochain/x/dex/client/utils"
...
$ evochaincli tx dex list --base-asset mytoken --quote-asset evo --from mykey
`),
...
$ evochaincli tx dex deposit mytoken_evo 1000evo --from mykey
...
$ evochaincli tx dex withdraw mytoken_evo 1000evo --from mykey
...
$ evochaincli tx dex register-operator --website http://xxx/operator.json --handling-fee-address addr --from mykey
`),
		RunE: func(cmd *cobra.Command, _ []string) error {
			cliCtx := context.NewCLIContext().WithCodec(cdc)
...
$ evochaincli tx dex edit-operator --website http://xxx/operator.json --handling-fee-address addr --from mykey
`),
		RunE: func(cmd *cobra.Command, _ []string) error {
			cliCtx := context.NewCLIContext().WithCodec(cdc)
