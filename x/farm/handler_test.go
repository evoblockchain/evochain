...
import (
	...
	swap "github.com/evoblockchain/evochain/x/ammswap"
	swaptypes "github.com/evoblockchain/evochain/x/ammswap/types"
...
type testContext struct {
	...
	addrList          []sdk.AccAddress // 1000 evo per address
	handler           sdk.Handler
}
	...
	tests := []testCaseItem{
		...
		},
		{
			...
			expectedErr: errors.New(
				"insufficient coins: insufficient funds: insufficient account funds; 89900.000000000000000000aab,101.000000000000000000ammswap_aab_ccb,89900.000000000000000000ccb,100000.000000000000000000ddb,1000.000000000000000000evo < 1.000000000000000000fff",
			),
		},
		{
...
func TestHandlerMsgDestroyPool(t *testing.T) {
	...
	tests := []testCaseItem{
		...
		},
		{
			...
			verification: verification,
			expectedErr:  types.ErrInvalidPoolOwner("evo1ss60jyagpw8v224006cqdkw22m32ytz54av3h3", "abc"),
		},
		{
			caseName: "failed. insufficient fee coins",
			preExec: func(t *testing.T, tCtx *testContext) interface{} {
			...
			getMsg:       normalGetDestroyPoolMsg,
			verification: verification,
			expectedErr:  errors.New("insufficient coins: insufficient funds: insufficient account funds; 10.000000000000000000evo < 1.000000000000000000fff"),
		},
		{
...
func TestHandlerMsgUnlock(t *testing.T) {
	...
	tests := []testCaseItem{
		...
		},
		{
			...
			getMsg:       normalGetUnlockMsg,
			verification: verification,
			expectedErr:  types.ErrNoLockInfoFound("evo1ss60jyagpw8v224006cqdkw22m32ytz54av3h3", "abc"),
		},
		{
			caseName: "failed. The coin name should be %s, not %s",
			preExec:  preExec,
