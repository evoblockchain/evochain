...
// default owner of evo
const DefaultTokenOwner = "evo1ss60jyagpw8v224006cqdkw22m32ytz54av3h3"
...
func defaultGenesisState() GenesisState {
	return GenesisState{
		...
		Tokens:       []types.Token{defaultGenesisStateEVO()},
		LockedAssets: nil,
		LockedFees:   nil,
	}
}

// default evo information
func defaultGenesisStateEVO() types.Token {
