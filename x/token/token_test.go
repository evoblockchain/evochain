...
func GenTx(msgs []sdk.Msg, accnums []uint64, seq []uint64, priv ...crypto.PrivKey) *auth.StdTx {
	...
	fee := auth.StdFee{
		// just for test - 0.01evo as fixed fee
...
func TestMsgTokenChown(t *testing.T) {
	...
	tokenIssueMsg := types.NewMsgTokenIssue(common.NativeToken, common.NativeToken, common.NativeToken, "evocoin", "1000", testAccounts[0].baseAccount.Address, true)
	...
	MsgErrorSupply := types.NewMsgTokenIssue("evo", "evo", "evo", "evocc", strconv.FormatInt(int64(10*1e10), 10), testAccounts[0].baseAccount.Address, true)
...
ok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-b`,
		common.NativeToken, common.NativeToken, "evocoin", "2100", testAccounts[0].baseAccount.Address, true)
	...
	//normal test
	symbName := "evo-b85" //addTokenSuffix(ctx,keeper,common.NativeToken)
...
func TestTxFailedFeeTable(t *testing.T) {
	...
	// failed issue msg : not enough evos .
