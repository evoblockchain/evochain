...
type Token struct {
	...
	Symbol              string         `json:"symbol" v2:"symbol"`                               // e.g. "evo"
	OriginalSymbol      string         `json:"original_symbol" v2:"original_symbol"`             // e.g. "EVO"
	WholeName           string         `json:"whole_name" v2:"whole_name"`                       // e.g. "EVO"
	...
	Owner               sdk.AccAddress `json:"owner" v2:"owner"`                                 // e.g. evo1ss60jyagpw8v224006cqdkw22m32ytz54av3h3
