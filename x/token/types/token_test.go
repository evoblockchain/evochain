...
func TestToken(t *testing.T) {
	...
	common.InitConfig()
	addr, err := sdk.AccAddressFromBech32("evo16zra6y26jytss520xrffq96p4fp4mnantcvyp2")
	require.Nil(t, err)
	...
	testCase := []struct {
		...
		{Token{
			Description:         "evoblockchain coin",
			Symbol:              common.NativeToken,
			OriginalSymbol:      common.NativeToken,
			WholeName:           "ok coin",
			...
			Owner:               addr,
			Mintable:            true,
		}, `{"description":"evoblockchain coin","symbol":"` + common.NativeToken + `","original_symbol":"` + common.NativeToken + `","whole_name":"ok coin","original_total_supply":"1000000000.000000000000000000","type":0,"owner":"evo16zra6y26jytss520xrffq96p4fp4mnantcvyp2","mintable":true}`},
	}
