...
var (
	...
	DefaultLogPath     = os.ExpandEnv("$HOME/.evochaind")
	defaultLogFileName = "evochaind.log"
...
func (cfg *Config) SetRoot(root string) *Config {
	...
	// evochain change LogFile base on cfg.BaseConfig.RootDir
...
func DefaultMempoolConfig() *MempoolConfig {
	return &MempoolConfig{
		...
		// ABCI Recheck
		Size:                       200_000,            // evochain memory pool size(max tx num)
