...
import (
	...
	"github.com/evoblockchain/evochain/libs/cosmos-sdk/server/config"
	...
	tmflags "github.com/evoblockchain/evochain/libs/tendermint/libs/cli/flags"
...
func interceptLoadConfig() (conf *cfg.Config, err error) {
	...
	appConfigFilePath := filepath.Join(rootDir, "config/evochaind.toml")
	if _, err := os.Stat(appConfigFilePath); os.IsNotExist(err) {
		appConf, _ := config.ParseConfig()
		config.WriteConfigFile(appConfigFilePath, appConf)
	}

	viper.SetConfigName("evochaind")
