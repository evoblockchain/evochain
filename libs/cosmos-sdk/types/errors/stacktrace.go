...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/evoblockchain/evochain/libs/cosmos-sdk/types/errors.Wrap",
		"github.com/evoblockchain/evochain/libs/cosmos-sdk/types/errors.Wrapf",
		"github.com/evoblockchain/evochain/libs/cosmos-sdk/types/errors.WithType",
