...
import (
	...
	sdkmaps "github.com/evoblockchain/evochain/libs/cosmos-sdk/store/internal/maps"
	"github.com/evoblockchain/evochain/libs/cosmos-sdk/store/mem"
	"github.com/evoblockchain/evochain/libs/cosmos-sdk/store/mpt"
	"github.com/evoblockchain/evochain/libs/tendermint/crypto/merkle"

	jsoniter "github.com/json-iterator/go"
	"github.com/evoblockchain/evochain/libs/cosmos-sdk/store/cachemulti"
	"github.com/evoblockchain/evochain/libs/cosmos-sdk/store/dbadapter"
	...
	"github.com/evoblockchain/evochain/libs/cosmos-sdk/store/tracekv"
	"github.com/evoblockchain/evochain/libs/cosmos-sdk/store/transient"
	...
	iavltree "github.com/evoblockchain/evochain/libs/iavl"
	"github.com/evoblockchain/evochain/libs/iavl/config"
	...
	tmlog "github.com/evoblockchain/evochain/libs/tendermint/libs/log"
...
func (rs *Store) loadVersion(ver int64, upgrades *types.StoreUpgrades) error {
	...
	if len(rs.pruneHeights) > maxPruneHeightsLength {
		return fmt.Errorf("Pruned heights length <%d> exceeds <%d>, "+
			...
			"<evochaind data prune-compact all --home your_evochaind_home_directory> before running evochaind",
