...
import (
	...
	evo_types "github.com/evoblockchain/evochain/libs/cosmos-sdk/x/bank/internal/types"
)
...
func (m *MsgSend) RulesFilter() (sdk.Msg, error) {
	...
	for i, amount := range msgSend.Amount {
		if amount.Denom == sdk.DefaultIbcWei {
			...
			return nil, sdkerrors.Wrap(sdkerrors.ErrInvalidCoins, "MsgSend not support evo denom")
		}
	}
	return &msgSend, nil
}
...
func (msg *MsgMultiSend) ValidateBasic() error {
	...
	if len(msg.Inputs) == 0 {
		return evo_types.ErrNoInputs
	}
	if len(msg.Outputs) == 0 {
		return evo_types.ErrNoOutputs
	}
...
func ValidateInputsOutputs(inputs []Input, outputs []Output) error {
	...
	if !totalIn.IsEqual(totalOut) {
		return evo_types.ErrInputOutputMismatch
	}
