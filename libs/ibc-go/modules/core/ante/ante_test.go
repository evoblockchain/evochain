...
import (
	appante "github.com/evoblockchain/evochain/app/ante"
...
func (suite *AnteTestSuite) TestAnteDecorator() {
	testCases := []struct {
		...
		},
		{
			...
			func(suite *AnteTestSuite) []ibcmsg.Msg {
				msgs := []ibcmsg.Msg{&clienttypes.MsgUpdateClient{Signer: "evo1ss60jyagpw8v224006cqdkw22m32ytz54av3h3"}, &clienttypes.MsgUpdateClient{Signer: "evo1ss60jyagpw8v224006cqdkw22m32ytz54av3h3"}, &clienttypes.MsgUpdateClient{Signer: "evo1ss60jyagpw8v224006cqdkw22m32ytz54av3h3"}}
