...
import (
	...
	types "github.com/evoblockchain/evochain/libs/cosmos-sdk/x/upgrade/typesadapter"
	"github.com/evoblockchain/evochain/libs/ibc-go/modules/core/exported"
	evochaingov "github.com/evoblockchain/evochain/x/gov/types"
)
...
func init() {
	...
	evochaingov.RegisterProposalType(ProposalTypeClientUpdate)
}
