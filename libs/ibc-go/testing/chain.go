...
import (
	...
	types2 "github.com/evoblockchain/evochain/libs/cosmos-sdk/codec/types"
	...
	//cryptotypes "github.com/evoblockchain/evochain/libs/cosmos-sdk/crypto/types"
	...
	authtypes "github.com/evoblockchain/evochain/libs/cosmos-sdk/x/auth/exported"

	//banktypes "github.com/evoblockchain/evochain/libs/cosmos-sdk/x/bank/types"
	...
	stakingtypes "github.com/evoblockchain/evochain/libs/cosmos-sdk/x/staking/types"
	...
	"github.com/evoblockchain/evochain/libs/tendermint/crypto/tmhash"
	tmprototypes "github.com/evoblockchain/evochain/libs/tendermint/proto/types"
	tmtypes "github.com/evoblockchain/evochain/libs/tendermint/types"
	tmprotoversion "github.com/evoblockchain/evochain/libs/tendermint/version"
	tmversion "github.com/evoblockchain/evochain/libs/tendermint/version"
	"github.com/stretchr/testify/require"

	"github.com/evoblockchain/evochain/app/crypto/ethsecp256k1"
	apptypes "github.com/evoblockchain/evochain/app/types"
	evoapptypes "github.com/evoblockchain/evochain/app/types"
	...
	ibctmtypes "github.com/evoblockchain/evochain/libs/ibc-go/modules/light-clients/07-tendermint/types"
...
func NewTestChain(t *testing.T, coord *Coordinator, chainID string) TestChainI {
	...
	//balance = sdk.NewCoins(evoblockchainchaintypes.NewPhotonCoin(amount))
...
func NewTestEthChain(t *testing.T, coord *Coordinator, chainID string) *TestChain {
	...
	genesisAcc := &evoapptypes.EthAccount{
