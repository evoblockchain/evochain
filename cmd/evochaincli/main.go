...
import (
	...
	sdkclient "github.com/evoblockchain/evochain/libs/cosmos-sdk/client"
	...
	clientrpc "github.com/evoblockchain/evochain/libs/cosmos-sdk/client/rpc"
	sdkcodec "github.com/evoblockchain/evochain/libs/cosmos-sdk/codec"
	...
	authcmd "github.com/evoblockchain/evochain/libs/cosmos-sdk/x/auth/client/cli"
	...
	tokencmd "github.com/evoblockchain/evochain/x/token/client/cli"
...
func main() {
	...
	rootCmd := &cobra.Command{
		Use:   "evochaincli",
		Short: "Command line interface for interacting with evochaind",
	}
	...
	// Add flags and prefix all env exposed with EVOCHAIN
	executor := cli.PrepareMainCmd(rootCmd, "EVOCHAIN", app.DefaultCLIHome)
