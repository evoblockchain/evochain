...
import (
	...
	"github.com/evoblockchain/evochain/app/rpc/websockets"
	...
	"github.com/evoblockchain/evochain/libs/tendermint/libs/automation"
	tmtypes "github.com/evoblockchain/evochain/libs/tendermint/types"
	tmdb "github.com/evoblockchain/evochain/libs/tm-db"
...
func RegisterAppFlag(cmd *cobra.Command) {
	...
	cmd.Flags().Bool(config.FlagPprofUseCGroup, false, "Use cgroup when evochaind run in docker")
