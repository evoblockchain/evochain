...
import (
	...
	srvconfig "github.com/evoblockchain/evochain/libs/cosmos-sdk/server/config"
...
var mnemonicList = []string{
	"photo toward leg retreat sound tornado way message rapid piece mercy oval",
	"own rabbit okay peasant capable coin walnut benefit movie collect move cross",
	"quality wish attend position degree train giant inflict finger icon arctic focus",
	"panther culture joy pelican song myth harsh silent rifle hood fly duck",
}
...
func TestnetCmd(ctx *server.Context, cdc *codec.Codec,
	...
	cmd := &cobra.Command{
		Use:   "testnet",
		Short: "Initialize files for an EVOChain testnet",
		Long: `testnet will create "v" number of directories and populate each with
necessary files (private validator, genesis, config, etc.).

Note, strict routability for addresses is turned off in the config file.`,

		Example: "evochaind testnet --v 4 --keyring-backend test --output-dir ./output --starting-ip-address 192.168.10.2",
	...
	cmd.Flags().String(flagNodeDaemonHome, "evochaind", "Home directory of the node's daemon configuration")
	cmd.Flags().String(flagNodeCLIHome, "evochaincli", "Home directory of the node's cli configuration")
...
func InitTestnet(
	...
	if chainID == "" {
		chainID = fmt.Sprintf("evochain-%d", tmrand.Int63n(9999999999999)+1)
	}
