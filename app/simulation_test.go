...
import (
	...
	wasmtypes "github.com/evoblockchain/evochain/x/wasm/types"
	"math/rand"
	"os"
	"testing"
	"time"
	...
	distr "github.com/evoblockchain/evochain/libs/cosmos-sdk/x/distribution"
...
func TestFullAppSimulation(t *testing.T) {
	...
	app := NewEVOChainApp(logger, db, nil, true, map[int64]bool{}, simapp.FlagPeriodValue, fauxMerkleModeOpt)
...
func TestAppImportExport(t *testing.T) {
	...
	newApp := NewEVOChainApp(log.NewNopLogger(), newDB, nil, true, map[int64]bool{}, simapp.FlagPeriodValue, fauxMerkleModeOpt)
	...
	normalizeContractInfo := func(ctx sdk.Context, app *EVOChainApp) {
		var index uint64
...
func TestAppStateDeterminism(t *testing.T) {
	...
	for i := 0; i < numTimesToRunPerSeed; i++ {
		...
		app := NewEVOChainApp(logger, db, nil, true, map[int64]bool{}, simapp.FlagPeriodValue, interBlockCacheOpt())
