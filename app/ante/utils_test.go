...
import (
	...
	helpers2 "github.com/evoblockchain/evochain/libs/ibc-go/testing/simapp/helpers"
	"math/big"
	"testing"
	"time"
	...
	ante "github.com/evoblockchain/evochain/app/ante"
...
func (suite *AnteTestSuite) SetupTest() {
	...
	err := evoblockchain.SetChainId(chainId)
	suite.Nil(err)
...
func newTestCoins() sdk.Coins {
	return sdk.NewCoins(evoblockchain.NewPhotonCoinInt64(500000000))
}

func newTestStdFee() auth.StdFee {
	return auth.NewStdFee(220000, sdk.NewCoins(evoblockchain.NewPhotonCoinInt64(150)))
}
...
func newTestEthTx(ctx sdk.Context, msg *evmtypes.MsgEthereumTx, priv tmcrypto.PrivKey) (sdk.Tx, error) {
	chainIDEpoch, err := evoblockchain.ParseChainID(ctx.ChainID())
	if err != nil {
		return nil, err
	}
