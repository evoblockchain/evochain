...
import (
	...
	"github.com/evoblockchain/evochain/libs/cosmos-sdk/crypto/keys/mintkey"
	...
	"github.com/evoblockchain/evochain/app/crypto/ethkeystore"
...
func (api *PrivateAccountAPI) NewAccount(password string) (common.Address, error) {
	...
	api.logger.Info("Please backup your key file!", "path", os.Getenv("HOME")+"/.evochaind/"+name)
