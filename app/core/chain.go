...
// transactions. There should only be a single implementation in EVOChain. For
// the purposes of EVOChain, it should be support retrieving headers and
// consensus parameters from  the current blockchain to be used during
// transaction processing.
//
// NOTE: EVOChain will distribute the fees out to validators, so the structure
