...
import (
	...
	ethcdc "github.com/evoblockchain/evochain/app/codec"
)
...
// file.
func (app *EVOChainApp) ExportAppStateAndValidators(
...
func (app *EVOChainApp) prepForZeroHeightGenesis(ctx sdk.Context, jailWhiteList []string) {
