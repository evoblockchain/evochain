...
import (
	...
	mpttypes "github.com/evoblockchain/evochain/libs/cosmos-sdk/store/mpt"
	...
	"github.com/evoblockchain/evochain/libs/tendermint/mock"
	"github.com/evoblockchain/evochain/libs/tendermint/node"
...
func newRepairApp(logger tmlog.Logger, db dbm.DB, traceStore io.Writer) *repairApp {
	return &repairApp{db, NewEVOChainApp(
		logger,
		db,
		traceStore,
		false,
