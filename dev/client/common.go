...
import (
	...
	//"github.com/evoblockchain/evochain-ethereum-compatible/utils"
...
const (
	//RpcUrl          = "https://evochaintestrpc.evoblockchain.org"
	RpcUrl        = "http://127.0.0.1:8545"
	ChainId int64 = 67 //  evo
	//RpcUrl          = "https://evochainrpc.evoblockchain.org"
	//ChainId int64   = 66 //  evo
...
func transferEVO(client *ethclient.Client,
	fromAddress common.Address,
...
func send(client *ethclient.Client, to, privKey string) {
	...
	// send 0.001evo
	transferEVO(client, senderAddress, toAddress, str2bigInt("0.001"), privateKey, 0)
}
