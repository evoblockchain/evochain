...
run() {
    ...
    evochaind start --rpc.unsafe \
      ...
      --rest.laddr "tcp://localhost:8545" > evo.txt 2>&1 &
...
evochaincli keys add --recover account2 -m "also voice sock art correct select yellow super grief ozone spot chuckle" -y --algo="" --coin-type 118
...
evochaind add-genesis-account $(evochaincli keys show $KEY    -a) 100000000evo --home $HOME_SERVER
evochaind add-genesis-account $(evochaincli keys show account2 -a) 900000000evo --home $HOME_SERVER
evochaind add-genesis-account $(evochaincli keys show account3 -a) 900000000evo --home $HOME_SERVER
evochaind add-genesis-account $(evochaincli keys show account4 -a) 900000000evo --home $HOME_SERVER
